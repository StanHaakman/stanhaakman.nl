...
function Navbar(props) {
    ...
    return (
      <nav className={"nav fixed top-0 w-full justify-center px-5 sm:px-10 py-5 z-10 flex " + menu}>
        <div className="container flex justify-between items-center">
          ...
          <div className={"menu-trigger relative h-10 w-10 m-2 open:bg-black hover:cursor-pointer " + menu} onClick={() => setMenu((menu === 'open') ? 'closed' : 'open')}>
